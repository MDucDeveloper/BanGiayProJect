...
<div class="container-fluid  bg-dark" style="height: 100px;padding: 0px">
   <header style="padding-top: 5px;color: white" class="col-lg-12 d-flex justify-content-between container">
